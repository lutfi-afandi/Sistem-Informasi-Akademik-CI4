                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="password" class="form-control" placeholder="Password Mahasiswa...">
                                    </div>
                                </div>
                                ...
                                <div class="col-sm-12">
                                    <div class="form-group">
                                        ...
                                        <input type="file" id="preview_gambar" name="foto_mhs" class="form-control" placeholder="foto...">
                                    </div>
                                </div>
