    ...
    <div class="col-sm-6">
        <div class="box box-success box-solid">
            ...
            <div class="box-body">
                ...
                <div class="form-group">
                    ...
                    <select name="gedung" id="" class="form-control" required>
                        ...
                        <?php foreach ($gedung as $key => $value) { ?>
                            <option value="<?php echo $value['id_gedung'] ?>" <?php echo $retVal = ($value['id_gedung'] == $ruangan['id_gedung']) ? "selected" : ""; ?>><?= $value['gedung']; ?></option>
                        <?php } ?>
                ...
                <div class="form-group">
                    <label>Ruangan</label>
                    <input type="text" name="ruangan" class="form-control" required value="<?= $ruangan['ruangan']; ?>">
                </div>
